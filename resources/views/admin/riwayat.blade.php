        ...
        <table class="table bordered-table mb-0 min-w-max" id="dataTable" data-page-length='10'>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $item->tipe_nyeri_dada == 0 ? 'Typical Angina' : ($item->tipe_nyeri_dada == 1 ? 'Atypical Angina' : ($item->tipe_nyeri_dada == 2 ? 'Non-anginal' : 'Asymptomatic')) }}</td>
              <td>{{ $item->tekanan_darah_istirahat }} mmHg</td>
              ...
              <td>{{ \Carbon\Carbon::parse($item->created_at)->locale('id')->translatedFormat('d M Y H:i') }}</td>
            </tr>
            @endforeach
          </tbody>
        </table>
